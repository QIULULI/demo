...
detector.diff_model.config = 'DA/Ours/sim_to_real/diffusion_detector_drone_from_fused.py' 
detector.diff_model.pretrained_model = 'work_dirs/DG/Ours/drone/fused_teacher_stage1_A/best_coco_bbox_mAP_50_iter_20000.pth' 
