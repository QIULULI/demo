...
detector.diff_model.config = 'DG/Ours/drone/diffusion_detector_drone_rgb_sim.py'  # 指向仿真域训练的扩散检测器配置
detector.diff_model.pretrained_model = '/mnt/ssd/lql/Fitness-Generalization-Transferability/work_dirs/diffusion_detector_drone_rgb_sim/best_coco_bbox_mAP_50_iter_20000.pth'  # 指向扩散教师的预训练权重
