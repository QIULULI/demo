_base_ = [  # 指定要继承的基础配置列表
    ...
    '../../_base_/datasets/sim_to_real/semi_drone_rgb_aug.py'  # 使用仿真RGB到真实RGB数据集配置
]  # 结束基础配置定义
...
detector.diff_model.config = 'DG/Ours/drone/fused_diff_teacher_stage1_A_rpn_roi.py' #'DG/Ours/drone/diffusion_detector_drone_rgb_sim.py'  # 指向仿真域训练的扩散检测器配置
detector.diff_model.pretrained_model = 'work_dirs/DG/Ours/drone/fused_teacher_stage1_A/best_coco_bbox_mAP_50_iter_20000.pth' #'/mnt/ssd/lql/Fitness-Generalization-Transferability/work_dirs/diffusion_detector_drone_rgb_sim/best_coco_bbox_mAP_50_iter_20000.pth'  # 指向扩散教师的预训练权重
