_base_ = [  # 指定要继承的基础配置列表
    ...
    '../../_base_/datasets/sim_to_real/semi_drone_rgb_test.py' # 测试时使用的仿真RGB到真实RGB数据集配置
]  # 结束基础配置定义
...
work_dir = 'work_dirs/DG/Ours/drone/simRGBtestOnReal-stage2'  # 设置工作目录以满足Stage-1融合教师导出规范并确保权重保存路径统一
