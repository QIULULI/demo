...
detector.detector.said_mask_mode = 'soft'  # SAID 频域掩码使用软分段（可在需要时改为 'hard' 或 'free'）
detector.detector.shared_mask_across_levels = True  # 在所有 FPN 层共享径向掩码（如需分层学习可置 False）
