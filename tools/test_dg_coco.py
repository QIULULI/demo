...
def main():
    ...
    for test_config in config_list:
        ...
        cfg.val_dataloader = test_cfg.val_dataloader
        ...
        # if 'clipart' in test_config or 'comic' in test_config or 'watercolor' in test_config:
        #     cfg.model.backbone.diff_config.scheduler_timesteps = [400, 200]
